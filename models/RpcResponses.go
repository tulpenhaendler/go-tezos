...
type DelegateDetails struct {
	...
	Delegate      string
	Balance       uint64 `json:"balance,string"`
	FrozenBalance uint64 `json:"frozen_balance,string"`
	...
	StakingBalance     uint64   `json:"staking_balance" `
	DelegatedBalance   uint64   `json:"delegated_balance,string"`
	Deactivated        bool     `json:"deactivated"`
	GracePeriod        int      `json:"grace_period"`
}

type LevelEndorseRights struct {
...
type CycleEndorseRights []LevelEndorseRights